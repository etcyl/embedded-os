...
int main() {
    ...
    sArgs[1].end = end2;
    pthread_create(&threads[1], NULL, bubbleSort, &sArgs[1]); //deal with second sublist

    sArgs[2].start = start11;
    sArgs[2].end = end11;
    pthread_create(&threads[2], NULL, bubbleSort, &sArgs[2]); 

    sArgs[3].start = start22;
    sArgs[3].end = end22;
    pthread_create(&threads[3], NULL, bubbleSort, &sArgs[3]);
    ...
    mArgs[1].begin = start1;
    mArgs[1].mid = end1;//start2;
    mArgs[1].end = end2;//end2;
    pthread_create(&threads[4], NULL, merge, &mArgs[1]); //merge the sublists into sorted[]!

    mArgs[2].begin = start11;
    mArgs[2].mid = end11;
    mArgs[2].end = end22;
    pthread_create(&threads[5], NULL, merge, &mArgs[2]);
